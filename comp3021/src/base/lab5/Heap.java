...
public class Heap<T extends Comparable<T>> {
    ...
    public T poll() {
        ...
        container.remove(container.size()-1); // replace this line with implementation
        heapifyDown();
        return temp;
    }
    ...
    private void heapifyUp() {
        PriorityQueue<T> heap = new PriorityQueue<>(container);

        ArrayList<T> arrayList = new ArrayList<>(heap);
        container = arrayList;
        // TODO
    }
